...
$user = $user_dir[0];
$auto_dir_with_user = explode('/',dirname(dirname($_SERVER['PHP_SELF'])));
$auto_dir = $auto_dir_with_user[2];

//win
$auto_dir = str_replace('/', '', dirname(dirname($_SERVER['PHP_SELF'])));


define('DS',DIRECTORY_SEPARATOR);
//define('AUTOMATION_DIR', $user.DS.'public_html/'.$auto_dir);
define('AUTOMATION_DIR', $_SERVER['DOCUMENT_ROOT'].DS.$auto_dir); //win
#define('AUTOMATION_DIR', $automation_path); //win
echo AUTOMATION_DIR;
