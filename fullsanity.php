...
$arrayOrder=array("Upgrade","upgradekeepconfig","UpgradeandBasicConfig","Sanity","iptvpiptestcase","Packager","PackagerTestcase","bulkandreboot","databasetestcase","vmgrebootalloptions","npmredundancy","safemodetestcases","extratestcase");
                                                                        ...
                                                                        <tr>
                                                                         <?php 
                                                                          ...
                                                                          ?>
                                                                                  ...
                                                                                  else if(strtolower($folderName)=="upgradeandbasicconfig"){
                                                                                        print "Basic Config";
                                                                                  }
                                                                                  else if(strtolower($folderName)=="sanity"){
                                                                                        print "Channel/Preset/Output";
                                                                                  }
                                                                                  else if(strtolower($folderName)=="packager"){
                                                                                        print "Packager Configuration";
                                                                                  }
                                                                                  else if(strtolower($folderName)=="packagertestcase"){
                                                                                        print "Packager";
                                                                                  }
                                                                                  else if(strtolower($folderName)=="iptvpiptestcase"){
                                                                                        print "IPTV/PIP";
                                                                                  }
                                                                                  
                                                                                  else if(strtolower($folderName)=="bulkandreboot"){
                                                                                        print "Bulk Config and Reboot";
                                                                                  }
                                                                                  
                                                                                  else if(strtolower($folderName)=="databasetestcase"){
                                                 ...
                                                 <?php
                                                        foreach($testcaseArray as $Key=>$Value){
                                                                ...
                                                                print "<br>";*/
                                                                  ...
                                                                  else if(strtolower($Key)=="upgradeandbasicconfig"){
                                                                        $displayKey="Basic Config";
                                                                  }
                                                                  else if(strtolower($Key)=="sanity"){
                                                                        $displayKey="Channel/Preset/Output";
                                                                  }
                                                                  else if(strtolower($Key)=="packager"){
                                                                        $displayKey="Packager Configuration";
                                                                  }
                                                                  else if(strtolower($Key)=="packagertestcase"){
                                                                        $displayKey="Packager";
                                                                  }
                                                                  else if(strtolower($Key)=="iptvpiptestcase"){
                                                                        $displayKey="IPTV/PIP";
                                                                  }
                                                                  
                                                                  else if(strtolower($Key)=="bulkandreboot"){
                                                                        $displayKey="Bulk Config and Reboot";
                                                                  }
                                                                  
                                                                  else if(strtolower($Key)=="databasetestcase"){
