...
$arrayOrder=array("gen2upgrade","gen2upgradekeepconfig","gen2fullbasicconfig","gen2fullselective","gen2fullchannelpreset","gen2fulliptv","gen2fullpackagerconfig","gen2fullpackager","gen2fullbulkandreboot","gen2fullbulkandrebootwithoutpkg","gen2fulldatabase","gen2vmgrebootalloptions","gen2npmredundancy","gen2safemodetestcases","gen2extratestcases","gen2secondverchannelpreset","gen2esstattestcases");
                                                ...
                                                <table width="800" border="1" align="center" cellpadding="0" cellspacing="0">
                                                                        ...
                                                                        <tr>
                                                                         <?php 
                                                                          ...
                                                                          ?>
                                                                                  ...
                                                                                  <?php
                                                                                  if(strtolower($folderName)=="gen2upgrade"){
                                                                                        print "Gen2 Upgrade";
                                                                                  }
                                                                                  else if(strtolower($folderName)=="gen2upgradekeepconfig"){
                                                                                        print "Gen2 upgrade keeping config";
                                                                                  }
                                                                                  else if(strtolower($folderName)=="gen2fullbasicconfig"){
                                                                                        print "Gen2 Config";
                                                                                  }
                                                                                  else if(strtolower($folderName)=="gen2fullselective"){
                                                                                        print "Selective Gen1 testcases for Gen2";
                                                                                  }
                                                                                  else if(strtolower($folderName)=="gen2fullchannelpreset"){
                                                                                        print "Channel/Preset/Output";
                                                                                  }
                                                                                  else if(strtolower($folderName)=="gen2fulliptv"){
                                                                                        print "IPTV testcases";
                                                                                  }
                                                                                  else if(strtolower($folderName)=="gen2fullpackagerconfig"){
                                                                                        print "Packager Configuration";
                                                                                  }
                                                                                  else if(strtolower($folderName)=="gen2fullpackager"){
                                                                                        print "Packager";
                                                                                  }
                                                                                  else if(strtolower($folderName)=="gen2fullbulkandreboot"){
                                                                                        print "Bulk Config and Reboot";
                                                                                  }
                                                                                  
                                                                                  else if(strtolower($folderName)=="gen2fulldatabase"){
                                                                                        print "Database backup and restore";
                                                                                  }
                                                                                  else if(strtolower($folderName)=="gen2fullbulkandrebootwithoutpkg"){
                                                                                        print "Bulk Config and Reboot without packager";
                                                                                  }
                                                                                  else if(strtolower($folderName)=="gen2vmgrebootalloptions"){
                                                                                        print "Different VMG Reboot options test";
                                                                                  }
                                                                                  else if(strtolower($folderName)=="gen2npmredundancy"){
                                                                                        print "Gen2 NPM redundancy testcase";
                                                                                  }
                                                                                  else if(strtolower($folderName)=="gen2safemodetestcases"){
                                                                                        print "Gen2 Safe Mode testcase";
                                                                                  }
                                                                                  else if(strtolower($folderName)=="gen2extratestcases"){
                                                                                        print "Gen2 extra testcases";
                                                                                  }
                                                                                  else if(strtolower($folderName)=="gen2secondverchannelpreset"){
                                                                                        print "Gen2 v1_1 testcases";
                                                                                  }
                                                                                  else if(strtolower($folderName)=="gen2esstattestcases"){
                                                                                        print "Gen2 EStram Stat testcases";
                                                                                  }
                                                 ...
                                                 <?php
                                                        foreach($testcaseArray as $Key=>$Value){
                                                                /*print $Key;
                                                                print "<br>";*/
                                                                  if(strtolower($Key)=="gen2upgrade"){
                                                                        $displayKey="Gen2 Upgrade";
                                                                  }
                                                                  else if(strtolower($Key)=="gen2upgradekeepconfig"){
                                                                        $displayKey="Gen2 upgrade keeping config";
                                                                  }
                                                                  else if(strtolower($Key)=="gen2fullbasicconfig"){
                                                                        $displayKey="Gen2 Config";
                                                                  }
                                                                  else if(strtolower($Key)=="gen2fullselective"){
                                                                        $displayKey="Selective Gen1 testcases for Gen2";
                                                                  }
                                                                  else if(strtolower($Key)=="gen2fullchannelpreset"){
                                                                        $displayKey="Channel/Preset/Output";
                                                                  }
                                                                  else if(strtolower($Key)=="gen2fulliptv"){
                                                                        $displayKey="IPTV testcases";
                                                                  }
                                                                  else if(strtolower($Key)=="gen2fullpackagerconfig"){
                                                                        $displayKey="Packager Configuration";
                                                                  }
                                                                  else if(strtolower($Key)=="gen2fullpackager"){
                                                                        $displayKey="Packager";
                                                                  }
                                                                  
                                                                  else if(strtolower($Key)=="gen2fullbulkandreboot"){
                                                                        $displayKey="Bulk Config and Reboot";
                                                                  }
                                                                  
                                                                  else if(strtolower($Key)=="gen2fulldatabase"){
                                                                        $displayKey="Database backup and restore";
                                                                  }
                                                                  else if(strtolower($Key)=="gen2fullbulkandrebootwithoutpkg"){
                                                                        $displayKey="Bulk and reboot without packager";
                                                                  }
                                                                  else if(strtolower($Key)=="gen2vmgrebootalloptions"){
                                                                        $displayKey="Different VMG Reboot options";
                                                                  }
                                                                  else if(strtolower($Key)=="gen2npmredundancy"){
                                                                        $displayKey="Gen2 NPM redundancy testcase";
                                                                  }
                                                                  else if(strtolower($Key)=="gen2safemodetestcases"){
                                                                        $displayKey="Gen2 Safe Mode testcase";
                                                                  }
                                                                  else if(strtolower($Key)=="gen2extratestcases"){
                                                                        $displayKey="Gen2 extra testcases";
                                                                  }
                                                                  else if(strtolower($Key)=="gen2secondverchannelpreset"){
                                                                        $displayKey="Gen2 v1_1 testcases";
                                                                  }
                                                                  else if(strtolower($Key)=="gen2esstattestcases"){
                                                                        $displayKey="Gen2 EStram stat testcases";
                                                                  }
