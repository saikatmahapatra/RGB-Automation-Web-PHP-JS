...
$arrayOrder=array("gen2upgrade","gen2upgradekeepconfig","gen2basicconfig","gen2selective","gen2channelpreset","gen2iptv","gen2packagerconfig","gen2packager","gen2bulkandreboot","gen2bulkandrebootwithoutpkg","gen2database","gen2vmgrebootalloptions","gen2npmredundancy","gen2safemodetestcases","gen2extratestcases","gen2secondverchannelpreset","gen2esstattestcases");
                                                                        ...
                                                                        <tr>
                                                                         <?php 
                                                                          ...
                                                                          ?>
                                                                                  ...
                                                                                  if(strtolower($folderName)=="gen2upgrade"){
                                                                                  ...
                                                                                  else if(strtolower($folderName)=="gen2basicconfig"){
                                                                                        print "Gen2 Config";
                                                                                  }
                                                                                  else if(strtolower($folderName)=="gen2selective"){
                                                                                        print "Gen2 Selective";
                                                                                  }
                                                                                  else if(strtolower($folderName)=="gen2channelpreset"){
                                                                                        print "Channel/Preset/Output";
                                                                                  }
                                                                                  else if(strtolower($folderName)=="gen2packagerconfig"){
                                                                                        print "Packager Configuration";
                                                                                  }
                                                                                  else if(strtolower($folderName)=="gen2packager"){
                                                                                        print "Packager";
                                                                                  }
                                                                                  else if(strtolower($folderName)=="gen2iptv"){
                                                                                        print "IPTV/PIP";
                                                                                  }
                                                                                  ...
                                                                                  else if(strtolower($folderName)=="gen2bulkandrebootwithoutpkg"){
                                                                                        print "Bulk Config and Reboot without Packager";
                                                                                  }
                                                                                  else if(strtolower($folderName)=="gen2database"){
                                                                                        print "Database backup and restore";
                                                                                  }
                                                                                  else if(strtolower($folderName)=="gen2vmgrebootalloptions"){
                                                                                        print "Different VMG Reboot options";
                                                                                  }
                                                                                        ...
                                                                                        print "Gen2 EStream stat testcases";
                                                                                  }
                                                 ...
                                                 <?php
                                                        foreach($testcaseArray as $Key=>$Value){
                                                                ...
                                                                print "<br>";*/
                                                                  if(strtolower($Key)=="gen2upgrade"){
                                                                  ...
                                                                  else if(strtolower($Key)=="gen2basicconfig"){
                                                                        $displayKey="Gen2 Config";
                                                                  }
                                                                  else if(strtolower($Key)=="gen2selective"){
                                                                        $displayKey="Gen2 Selective";
                                                                  }
                                                                  else if(strtolower($Key)=="gen2channelpreset"){
                                                                        $displayKey="Channel/Preset/Output";
                                                                  }
                                                                  else if(strtolower($Key)=="gen2packagerconfig"){
                                                                        $displayKey="Packager Configuration";
                                                                  }
                                                                  else if(strtolower($Key)=="gen2packager"){
                                                                        $displayKey="Packager";
                                                                  }
                                                                  else if(strtolower($Key)=="gen2iptv"){
                                                                        $displayKey="IPTV/PIP";
                                                                  }
                                                                  else if(strtolower($Key)=="gen2bulkandreboot"){
                                                                        $displayKey="Bulk Config and Reboot";
                                                                  }
                                                                  else if(strtolower($Key)=="gen2bulkandrebootwithoutpkg"){
                                                                        $displayKey="Bulk Config and Reboot without packager";
                                                                  }
                                                                  else if(strtolower($Key)=="gen2database"){
                                                                        ...
                                                                        $displayKey="Gen2 EStream stat testcases";
                                                                  }
