...
$arrayOrder=array("gen2upgradekeepconfig","gen2channelpresetset1","gen2packagerconfigset1","gen2packagertestcaseset1","gen2vmgrebootalloptions");
                                                                        ...
                                                                        <tr>
                                                                         <?php 
                                                                          ...
                                                                          ?>
                                                                                  ...
                                                                                  else if(strtolower($folderName)=="gen2channelpresetset1"){
                                                                                        print "Gen2 Channel Preset Set - 1";
                                                                                  }
                                                                                  else if(strtolower($folderName)=="gen2packagerconfigset1"){
                                                                                        print "Gen2 Packager Config Set - 1";
                                                                                  }
                                                                                  else if(strtolower($folderName)=="gen2packagertestcaseset1"){
                                                                                        print "Gen2 Packager Testcases Set - 1";
                                                                                  }
                                                 ...
                                                 <?php
                                                        foreach($testcaseArray as $Key=>$Value){
                                                                ...
                                                                print "<br>";*/
                                                                  ...
                                                                  else if(strtolower($Key)=="gen2channelpresetset1"){
                                                                        $displayKey="Gen2 Channel Preset Set - 1";
                                                                  }
                                                                  else if(strtolower($Key)=="gen2packagerconfigset1"){
                                                                        $displayKey="Gen2 Packager Config Set - 1";
                                                                  }
                                                                  else if(strtolower($Key)=="gen2packagertestcaseset1"){
                                                                        $displayKey="Gen2 Packager Testcases Set - 1";
                                                                  }
