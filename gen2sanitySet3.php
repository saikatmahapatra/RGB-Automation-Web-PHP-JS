...
$arrayOrder=array("gen2upgrade","gen2basicconfig","gen2channelpresetset3","gen2packagerconfigset3","gen2packagertestcaseset3","gen2database");
                                                                        ...
                                                                        <tr>
                                                                         <?php 
                                                                          ...
                                                                          ?>
                                                                                  ...
                                                                                  else if(strtolower($folderName)=="gen2channelpresetset3"){
                                                                                        print "Gen2 Channel Preset Set - 3";
                                                                                  }
                                                                                  else if(strtolower($folderName)=="gen2packagerconfigset3"){
                                                                                        print "Gen2 Packager Config Set - 3";
                                                                                  }
                                                                                  else if(strtolower($folderName)=="gen2packagertestcaseset3"){
                                                                                        print "Gen2 Packager Testcases Set -3";
                                                                                  }
                                                 ...
                                                 <?php
                                                        foreach($testcaseArray as $Key=>$Value){
                                                                ...
                                                                print "<br>";*/
                                                                  ...
                                                                  else if(strtolower($Key)=="gen2channelpresetset3"){
                                                                        $displayKey="Gen2 Channel Preset Set - 3";
                                                                  }
                                                                  else if(strtolower($Key)=="gen2packagerconfigset3"){
                                                                        $displayKey="Gen2 Packager Config Set - 3";
                                                                  }
                                                                  else if(strtolower($Key)=="gen2packagertestcaseset3"){
                                                                        $displayKey="Gen2 Packager testcases Set - 3";
                                                                  }
                                                                  else if(strtolower($Key)=="gen2database"){
                                                                        $displayKey="Gen2 Database backup and restore";
                                                                  }
