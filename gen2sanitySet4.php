...
$arrayOrder=array("gen2upgradekeepconfig","gen2channelpresetset4","gen2packagerconfigset4","gen2packagertestcaseset4","gen2vmgrebootalloptions");
                                                                        ...
                                                                        <tr>
                                                                         <?php 
                                                                          ...
                                                                          ?>
                                                                                  ...
                                                                                  else if(strtolower($folderName)=="gen2channelpresetset4"){
                                                                                        print "Gen2 Channel Preset Set - 4";
                                                                                  }
                                                                                  else if(strtolower($folderName)=="gen2packagerconfigset4"){
                                                                                        print "Gen2 Packager Config Set - 4";
                                                                                  }
                                                                                  else if(strtolower($folderName)=="gen2packagertestcaseset4"){
                                                                                        print "Gen2 Packager Testcases Set - 4";
                                                                                  }
                                                 ...
                                                 <?php
                                                        foreach($testcaseArray as $Key=>$Value){
                                                                ...
                                                                print "<br>";*/
                                                                  ...
                                                                  else if(strtolower($Key)=="gen2channelpresetset4"){
                                                                        $displayKey="Gen2 Channel Preset Set - 4";
                                                                  }
                                                                  else if(strtolower($Key)=="gen2packagerconfigset4"){
                                                                        $displayKey="Gen2 Packager Config Set - 4";
                                                                  }
                                                                  else if(strtolower($Key)=="gen2packagertestcaseset4"){
                                                                        $displayKey="Gen2 Packager Testcases Set - 4";
                                                                  }
