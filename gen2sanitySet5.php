...
$arrayOrder=array("gen2upgradekeepconfig","gen2channelpresetset5","gen2packagerconfigset5","gen2packagertestcaseset5","gen2bulkandreboot");
                                                                        ...
                                                                        <tr>
                                                                         <?php 
                                                                          ...
                                                                          ?>
                                                                                  ...
                                                                                  else if(strtolower($folderName)=="gen2channelpresetset5"){
                                                                                        print "Gen2 Channel Preset Set - 5";
                                                                                  }
                                                                                  else if(strtolower($folderName)=="gen2packagerconfigset5"){
                                                                                        print "Gen2 Packager Config Set - 5";
                                                                                  }
                                                                                  else if(strtolower($folderName)=="gen2packagertestcaseset5"){
                                                                                        print "Gen2 Packager Testcases Set - 5";
                                                                                  }
                                                 ...
                                                 <?php
                                                        foreach($testcaseArray as $Key=>$Value){
                                                                ...
                                                                print "<br>";*/
                                                                  ...
                                                                  else if(strtolower($Key)=="gen2channelpresetset5"){
                                                                        $displayKey="Gen2 Channel Preset Set - 5";
                                                                  }
                                                                  else if(strtolower($Key)=="gen2packagerconfigset5"){
                                                                        $displayKey="Gen2 Packager Config Set - 5";
                                                                  }
                                                                  else if(strtolower($Key)=="gen2packagertestcaseset5"){
                                                                        $displayKey="Gen2 Packager Testcases Set - 5";
                                                                  }
