                         ...
                         <tr>
                                ...
                                <form name="caseform" id='caseform' action="#" method="post" enctype="multipart/form-data" onsubmit="return callExecute();">
                                                <table width="800" border="1" align="center" cellpadding="0" cellspacing="0">
                                                                ...
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        <tr height="0">
                                                                         <?php 
                                                                                ...
                                                                                foreach($arrayOrder as $folderName){
                                                                          ?>
                                                                                  <td width="5%" align="left" valign="middle"><input type="hidden" name="itemSelect[]" class='itemSelect' id="itemSelect" value=<?php print strtolower($folderName);?> title="Please check to view the test cases of <?php print $folderName;?>"/></td>
                                                 ...
                                                 <tr>
                                                        <td align="left" valign="top">
                                                                <table width="100%" border="0" cellspacing="2" cellpadding="2" id="<?php print $Key;?>" style="display:block;">
                                                                  <tr>
                                                                ...
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                  <tr>
                                                                        ...
                                                                        <td align="center" valign="top"><input type="submit" name="submit_test" id="submit_test" value="Run Automation now" />
                                                                          <!--<input type="button" name="submit_test2" id="submit_test2" value="Schedule Automation" onclick="return popWindow('scheduleUI.php');"/>--> <input type="button" name="submit_abort" id="submit_abort" value="Abort Process" onclick="return callAbort();"/></td>
