...
$arrayOrder=array("quicksystemtest","quickchanneltest");
                                                ...
                                                <table width="800" border="1" align="center" cellpadding="0" cellspacing="0">
                                                                ...
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                         <?php 
                                                                                ...
                                                                                foreach($arrayOrder as $folderName){
                                                                          ?>
                                                                                  <td width="2%" align="left" valign="middle"><input type="checkbox" name="itemSelect[]" class='itemSelect' id="itemSelect" value=<?php print strtolower($folderName);?> title="Please check to view the test cases of <?php print $folderName;?>"/></td>
                                                                                  <td width="13%" align="left" valign="middle" nowrap="nowrap"><?php 
                                                                                  if(strtolower($folderName)=="quicksystemtest"){
                                                                                        print "Set up System/Devices cnfg";
                                                                                  }
                                                                                  else if(strtolower($folderName)=="quickchanneltest"){
                                                                                        print "Quick Channel Test";
                                                                                  }
                                                                                  else{
                                                 ...
                                                 <?php
                                                        foreach($testcaseArray as $Key=>$Value){
                                                                /*print $Key;
                                                                print "<br>";*/
                                                                  if(strtolower($Key)=="quicksystemtest"){
                                                                        $displayKey="Set up System/Devices cnfg";
                                                                  }
                                                                  else if(strtolower($Key)=="quickchanneltest"){
                                                                        $displayKey="Quick Channel Test";
                                                                  }
                                                                  else{
