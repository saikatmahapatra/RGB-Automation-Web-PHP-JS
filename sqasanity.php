...
$arrayOrder=array("upgrade","upgradekeepconfig","upgradekeepconfigsqa","sqabasicconfig","sqachannelpreset","sqaiptv","sqapackagerconfig","sqapackager","sqabulkandreboot","sqadatabase","vmgrebootalloptions","npmredundancy","safemodetestcases","extratestcase");
                                                ...
                                                <table width="800" border="1" align="center" cellpadding="0" cellspacing="0">
                                                                        ...
                                                                        <tr>
                                                                         <?php 
                                                                          ...
                                                                          ?>
                                                                                  ...
                                                                                  <?php
                                                                                  if(strtolower($folderName)=="upgrade"){
                                                                                        print "Upgrade";
                                                                                  }
                                                                                  else if(strtolower($folderName)=="upgradekeepconfig"){
                                                                                        print "Upgrade keeping config";
                                                                                  }
                                                                                  else if(strtolower($folderName)=="upgradekeepconfigsqa"){
                                                                                        print "Upgrade keeping config SQA";
                                                                                  }
                                                                                  else if(strtolower($folderName)=="sqabasicconfig"){
                                                                                        print "Basic Config";
                                                                                  }
                                                                                  else if(strtolower($folderName)=="sqachannelpreset"){
                                                                                        print "Channel/Preset/Output";
                                                                                  }
                                                                                  else if(strtolower($folderName)=="sqapackagerconfig"){
                                                                                        print "Packager Configuration";
                                                                                  }
                                                                                  else if(strtolower($folderName)=="sqapackager"){
                                                                                        print "Packager";
                                                                                  }
                                                                                  else if(strtolower($folderName)=="sqaiptv"){
                                                                                        print "IPTV/PIP";
                                                                                  }
                                                                                  
                                                                                  else if(strtolower($folderName)=="sqabulkandreboot"){
                                                                                        print "Bulk Config and Reboot";
                                                                                  }
                                                                                  
                                                                                  else if(strtolower($folderName)=="sqadatabase"){
                                                                                        print "Database backup and restore";
                                                                                  }
                                                                                  else if(strtolower($folderName)=="vmgrebootalloptions"){
                                                                                        print "Different VMG Reboot options";
                                                                                  }
                                                                                  else if(strtolower($folderName)=="npmredundancy"){
                                                                                        print "NPM redundancy testcase";
                                                                                  }
                                                                                  else if(strtolower($folderName)=="safemodetestcases"){
                                                                                        print "Safe Mode testcase";
                                                                                  }
                                                                                  else if(strtolower($folderName)=="extratestcase"){
                                                                                        print "Extra testcases";
                                                                                  }
                                                                                  else{
                                                 ...
                                                 <?php
                                                        foreach($testcaseArray as $Key=>$Value){
                                                                /*print $Key;
                                                                print "<br>";*/
                                                                  if(strtolower($Key)=="upgrade"){
                                                                        $displayKey="Upgrade";
                                                                  }
                                                                  else if(strtolower($Key)=="upgradekeepconfig"){
                                                                        $displayKey="Upgrade keeping config";
                                                                  }
                                                                  else if(strtolower($Key)=="upgradekeepconfigsqa"){
                                                                        $displayKey="Upgrade keeping config SQA";
                                                                  }
                                                                  else if(strtolower($Key)=="sqabasicconfig"){
                                                                        $displayKey="Basic Config";
                                                                  }
                                                                  else if(strtolower($Key)=="sqachannelpreset"){
                                                                        $displayKey="Channel/Preset/Output";
                                                                  }
                                                                  else if(strtolower($Key)=="sqapackagerconfig"){
                                                                        $displayKey="Packager Configuration";
                                                                  }
                                                                  else if(strtolower($Key)=="sqapackager"){
                                                                        $displayKey="Packager";
                                                                  }
                                                                  else if(strtolower($Key)=="sqaiptv"){
                                                                        $displayKey="IPTV/PIP";
                                                                  }
                                                                  
                                                                  else if(strtolower($Key)=="sqabulkandreboot"){
                                                                        $displayKey="Bulk Config and Reboot";
                                                                  }
                                                                  
                                                                  else if(strtolower($Key)=="sqadatabase"){
                                                                        $displayKey="Database backup and restore";
                                                                  }
                                                                  else if(strtolower($Key)=="vmgrebootalloptions"){
                                                                        $displayKey="Different VMG Reboot options";
                                                                  }
                                                                  else if(strtolower($Key)=="npmredundancy"){
                                                                        $displayKey="NPM redundancy testcase";
                                                                  }
                                                                  else if(strtolower($Key)=="safemodetestcases"){
                                                                        $displayKey="Safe mode testcase";
                                                                  }
                                                                  else if(strtolower($Key)=="extratestcase"){
                                                                        $displayKey="extra testcases";
                                                                  }
                                                                  else{
